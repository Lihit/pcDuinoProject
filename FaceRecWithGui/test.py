...
def main2():
    ...
    cv2.rectangle(img, (left, top), (right, bottom), (255, 255, 0), 1)
    cv2.rectangle(img, (left, bottom), (right, min(bottom+50,img.shape[0])), (255, 255, 0), 1)
    cv2.putText(img,name,(left+30, bottom+30),cv2.FONT_HERSHEY_DUPLEX,1,(255,255,255),2)
...
def main3():
    ...
    results = fr.compare_faces([jobs_encoding, obama_encoding], unknown_encoding)
    labels = ['obama', 'biden']
